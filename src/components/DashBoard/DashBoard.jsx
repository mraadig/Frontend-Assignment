        ...
        {selectedData.map((element, index) => {
          ...
          return (
            ...
            >
              ...
              alt="UserImage"
            /></div>
                    <span>{user}</span> {/* Display the username next to the image */}
                  </div>
                  ) : isStatus ? (
                    <div
                      className="cardTitle"
                ...
                <div className="rightView" style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                  <AiOutlinePlus />{""}
                  <span style={{ letterSpacing: "2px" , margin:"0px 0px 8px 0px"}}>...</span>
                </div>
              </div>
